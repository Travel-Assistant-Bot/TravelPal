...
const zodToJsonSchema = (schema, options) => {
    ...
    const definitions = !(0, util_1.isEmptyObj)(refs.definitions) ?
        Object.entries(refs.definitions).reduce((acc, [name, schema]) => ({
            ...acc,
            [name]: (0, parseDef_1.parseDef)((0, util_1.zodDef)(schema), {
                ...refs,
                currentPath: [...refs.basePath, refs.definitionPath, name],
            }, true) ?? {},
        }), {})
